...
<script type="text/javascript" src="../../js/result/SparkLine.js"></script>
...
<body>
	<div class="wrap">
	    ...
	    <div id="grdMain" style="height:220px;min-width:100px"></div><br><br>
	    <div class="dot-title">Grid-2</div>
	    <div id="grdMain2" style="height:220px;min-width:100px"></div>
	</div>
</body>
</html>